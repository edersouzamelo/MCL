...
const KNOWLEDGE_CHUNKS: KnowledgeChunk[] = [
  ...
  },
  {
    ...
    text:
      "O serviço financeiro da main ainda consome registros demonstrativos e um store SIAFI com valores fixos e campos derivados artificialmente. Além disso, o schema financeiro não oferece escopo organizacional suficiente para uma consulta segura pelo Assistente. O silo financeiro deve permanecer bloqueado na IA até a ingestão validada e a autorização por organização serem corrigidas e homologadas.",
    source: "src/modules/credits/service.ts e src/modules/connectors/siafi/store.ts",
    url: `${REPOSITORY_URL}/blob/main/src/modules/connectors/siafi/store.ts`,
