          ...
          {activeSubpage === "capa" && (
            <div className="space-y-3">
              <div className="credit-kpi-grid">
                ...
                <div className="credit-kpi-card bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-sm">
                  <span className="text-xs text-zinc-500 dark:text-zinc-400 font-semibold block uppercase">Movim. líquido PI/ND</span>
                  <span className="text-xl font-bold text-emerald-700 dark:text-emerald-400 block mt-1 font-mono">{tgSnapshot ? formatCurrency(totalPiNdMovement) : "—"}</span>
                </div>
                <div className="credit-kpi-card bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-sm">
                  <span className="text-xs text-zinc-500 dark:text-zinc-400 font-semibold block uppercase">Movim. líquido NE</span>
                  <span className="text-xl font-bold text-cyan-700 dark:text-cyan-400 block mt-1 font-mono">{tgSnapshot ? formatCurrency(totalNeMovement) : "—"}</span>
                </div>
              </div>
